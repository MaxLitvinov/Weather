...
import com.weather.service.open_weather_map.domain.mapper.DailyDtoMapper
import com.weather.service.open_weather_map.domain.mapper.HourlyDtoMapper
...
class WeatherDtoMapperTest {
    ...
    fun setup() {
        ...
        weatherDtoMapper = WeatherDtoMapper(currentDtoMapper, hourlyDtoMapper, dailyDtoMapper, timestampProvider)
    }
    ...
    fun `Check WeatherDto mapping`() {
        ...
        val todayTime = 1663146000L
        val tomorrowTime = 1663232400L
        val day3Time = 1663318800L
        val day4Time = 1663405200L
        val day5Time = 1663491600L
        val day6Time = 1663578000L
        val day7Time = 1663664400L
        val day8Time = 1663750800L
        ...
        every { dailyDtoMapper.mapToDomainModel(timezoneOffset, today) } returns todayDomain
        every { dailyDtoMapper.mapToDomainModel(timezoneOffset, tomorrow) } returns tomorrowDomain
        every { dailyDtoMapper.mapToDomainModel(timezoneOffset, day3) } returns day3Domain
        every { dailyDtoMapper.mapToDomainModel(timezoneOffset, day4) } returns day4Domain
        every { dailyDtoMapper.mapToDomainModel(timezoneOffset, day5) } returns day5Domain
        every { dailyDtoMapper.mapToDomainModel(timezoneOffset, day6) } returns day6Domain
        every { dailyDtoMapper.mapToDomainModel(timezoneOffset, day7) } returns day7Domain
        every { dailyDtoMapper.mapToDomainModel(timezoneOffset, day8) } returns day8Domain

        every { timestampProvider.toYearMonthDay(todayTime) } returns "2022-09-14"
        every { timestampProvider.toYearMonthDay(tomorrowTime) } returns "2022-09-15"
        every { timestampProvider.toYearMonthDay(day3Time) } returns "2022-09-16"
        every { timestampProvider.toYearMonthDay(day4Time) } returns "2022-09-17"
        every { timestampProvider.toYearMonthDay(day5Time) } returns "2022-09-18"
        every { timestampProvider.toYearMonthDay(day6Time) } returns "2022-09-19"
        every { timestampProvider.toYearMonthDay(day7Time) } returns "2022-09-20"
        every { timestampProvider.toYearMonthDay(day8Time) } returns "2022-09-21"
        ...
        assertEquals(expectedWeatherDomainModel, actualWeatherDomainModel)
    }
}
